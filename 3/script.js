...
const maps = [
    ...
    ], 'qwerty', ['explode', 'follow', 'straight', 'flight', 'rain', 'shield', 'mine', 'findpowerup']),
    new GameMap([
        new Platform(0, 0, 185, 10),
        new Platform(215, 0, 185, 10),
        new Platform(0, 10, 10, 175),
    ...
    ], 'qwerty3', ['bounce', 'explode', 'follow', 'straight', 'flight', 'rain', 'shield', 'mine', 'teleport']),
    new GameMap([
        new Platform(0, 0, 185, 10),
        new Platform(215, 0, 185, 10),
        new Platform(0, 10, 10, 175),
...
const main = function () {
    ...
    if (isStarted) {
        if (player.score >= 30 || otherPlayer.score >= 30) {
            if (!stopped) {
            ...
            bang(200, 200, 200, player.score >= 30 ? intensity : 0, 0, otherPlayer.score >= 30 ? intensity : 0);
        }
